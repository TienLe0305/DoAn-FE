...
const ExitIcon = () => (
  <svg viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="m5.39 7.501-4.947 4.93a1.505 1.505 0 1 0 2.13 2.128l5.996-5.994a1.5 1.5 0 0 0 0-2.128L2.572.443a1.5 1.5 0 0 0-2.129 0 1.5 1.5 0 0 0 0 2.128zm8.11 7.493a1.5 1.5 0 0 0 1.5-1.499V1.507a1.498 1.498 0 1 0-2.998 0v11.988a1.5 1.5 0 0 0 1.499 1.499"
      fill="#9E9E9E"
    />
  </svg>
);
